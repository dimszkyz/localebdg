...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\14. project dosen\ecomerce\public\storage' => 'string',
...
'cart.format.decimal_point','cart.format.thousand_seperator','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.links.D:\\14. project dosen\\ecomerce\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','image.driver',
'image.options.autoOrientation','image.options.decodeAnimation','image.options.blendingColor','image.options.strip','flare.key',
...
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','home.index',
'login','logout','register',
'password.request','password.email','password.reset','password.update','password.confirm','google.login','google.callback','shop.search','shop.index',
'shop.product.details','cart.index','cart.add','cart.qty.update','cart.qty.increase',
'cart.qty.decrease','cart.item.remove','cart.empty','cart.coupon.apply','cart.coupon.remove',
'wishlist.index','wishlist.add','wishlist.item.remove','wishlist.clear','wishlist.move.to.cart',
'cart.checkout','cart.place.an.order','cart.order.confirmation','home.help','help.category',
'home.contact','admin.contact.details','home.contact.store','home.search','home.about',
'home.welcome','user.index','user.orders','user.order.details','user.order.cancel',
'admin.order.search','user.address.index','user.address.add','user.address.store','user.address.edit',
'user.address.update','user.address.delete','admin.index','admin.brands','admin.brand.add',
'admin.brand.store','admin.brand.edit','admin.brand.update','admin.brand.delete','admin.brand.search',
'admin.categories','admin.category.add','admin.category.store','admin.category.edit','admin.category.update',
'admin.category.delete','admin.products','admin.product.add','admin.product.store','admin.product.edit',
'admin.product.update','admin.product.delete','admin.product.deleteImage.ajax','admin.product.search','admin.coupons',
'admin.coupon.add','admin.coupon.store','admin.coupon.edit','admin.coupon.update','admin.coupon.delete',
'admin.coupon.search','admin.orders','admin.order.details','admin.order.status.update','admin.slides',
'admin.slide.add','admin.slide.store','admin.slide.edit','admin.slide.update','admin.slide.delete',
'admin.contacts','admin.contact.delete','admin.search','admin.users','admin.user.details',
'admin.user.add','admin.user.store','admin.user.destroy','admin.user.search','admin.contact.search',
'admin.about.edit','admin.about.update',);
        registerArgumentsSet('views', 
'about','admin.brand-add','admin.brand-edit','admin.brands','admin.categories',
'admin.category-add','admin.category-edit','admin.contacts','admin.coupon-add','admin.coupon-edit',
'admin.coupons','admin.detail-contacts','admin.detail-user','admin.edit-about','admin.index',
'admin.order-details','admin.orders','admin.product-add','admin.product-edit','admin.products',
'admin.slide-add','admin.slide-edit','admin.slides','admin.tambah-user','admin.user',
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','cart','checkout','contact','details',
'help.akun','help.pembayaran','help.pengembalian','help.pengiriman','help.pesanan',
'help.produk','help.promosi','home','index','layouts.admin',
'layouts.app','order-confirmation','partials.address-form','search','shop',
'user.account-nav','user.address','user.address-add','user.address-edit','user.index',
'user.order-details','user.orders','welcome','wishlist','laravel-exceptions-renderer::components.card',
...
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.14. project dosen.ecomerce.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
